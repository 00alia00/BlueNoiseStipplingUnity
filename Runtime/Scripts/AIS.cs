...
namespace BlueNoise
{
    ...
    class AIS
    {
        ...
        public static void Stipple(Image source, int K, Image result )
        {
            ...
            Image diskBuffer = new Image(source.Width, source.Height);
            Graphics dgb = Graphics.FromImage(diskBuffer);
            dgb.Clear(Color.Black);

            Image sourceBmp = new Image(source.Width, source.Height);
            {
        ...
        /// </summary>
        private static bool Overlaps(Disk P, Image diskBuffer)
        {
        ...
        private static void AddStipple(Disk d, Image bmp)
        {
        ...
        private static bool ChangeRadiusBasedOnLocalDensity(Disk Q, Disk P, float alpha, Image bmp, float K, out Disk D)
        {
        ...
        /// </summary>
        private static float DiskDensity(Disk d, Image bmp)
        {
        ...
        /// </summary>
        private static int TotalDensity(Image bmp)
        {
            int totalDensity = 0;
